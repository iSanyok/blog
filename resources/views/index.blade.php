...
@section('content')
    ...
    <div id="sidebar">
        ...
        <ul class="nav nav-tabs" id="nav">
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('getToday')}}">Today</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('getWeek') }}" id="">Week</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('getMouth') }}">Mouth</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('getYear') }}">Year</a>
            </li>
        </ul>
